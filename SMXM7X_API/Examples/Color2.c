...
// Bayer
#define ID_MONO         300000
#define ID_NEAREST      300001
#define ID_BILINEAR     300002
#define ID_LAPLACIN     300003
#define ID_REALMONO     300004
#define ID_BAYERAVG     300005
...
void AddMenu(HWND hwin) {
    ...
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_MONO      , "Monochrome" );
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_NEAREST   , "Nearest Neighbor" );
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_BILINEAR  , "Bilinear" );
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_LAPLACIN  , "Laplacian" );
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_REALMONO  , "Real Monochrome" );
    AppendMenu( hmenu, MF_STRING | MF_ENABLED, ID_BAYERAVG  , "Bayer Average" );
}
...
*/ 
        ...
        case WM_SYSCOMMAND:
        {
            ...
            switch (wParam) { 
                ...
                case ID_MONO    : BayerAlgId = 0; return 0;
                case ID_NEAREST : BayerAlgId = 1; return 0;
                case ID_BILINEAR: BayerAlgId = 2; return 0;
                case ID_LAPLACIN: BayerAlgId = 3; return 0;
                case ID_REALMONO: BayerAlgId = 4; return 0;
                case ID_BAYERAVG: BayerAlgId = 5; return 0;
...
static void ThreadProc(void *foo) {
    ...
    while (hwin != INVALID_HANDLE_VALUE) {
        ...
        bmi.bmhi.biBitCount = 24; // 8;
        bmi.bmhi.biSizeImage = Params.Width * Params.Height * 3;

        CxBayerToRgb( frame, Params.Width, Params.Height, BayerAlgId, frameOut );
        //AlgNearestNeighbor( frame,Params.Width, Params.Height,frameOut);
        SetDIBitsToDevice( hdc, 0, 0, Params.Width, Params.Height, 0, 0, 0, Params.Height, frameOut, (BITMAPINFO *)&bmi, DIB_RGB_COLORS);
        ReleaseDC(hwin,hdc); 
        UpdateWindow(hwin);
