...
def optimise(f,data_directory,x0,max_iters,step_size):
    ...
    file_data.write("f,E0,max_iters,step_size,exposure,x0[0],x0[1],x0[2],x0[3],x0[4]\n")
    file_data.write("%a,%f,%i,%i,%f,%i,%i,%i,%i,%i\n"%(f,E,max_iters,step_size,fitness_functions.exposure,x0[0],x0[1],x0[2],x0[3],x0[4]))
    file_data.write("i,t,energy,I_total,I_max,x[0],x[1],x[2],x[3],x[4]\n")
    file_data.flush()
    ...
    for i in range(max_iters):
        ...
        #log data
        t = time.time() - t0
        file_data.write("%i,%f,%f,%i,%i,%i,%i,%i,%i,%i\n" % (i,t,E,I_total,I_max,x[0],x[1],x[2],x[3],x[4]))
        file_data.flush()
